...
print (int(intval2))
print (int(intval3)) 
print (int(floatval1))	   # Note that 2.8 becomes 2 because it drops the point value
print (int(floatval2))	   # Note that -4.6 becomes -4
print (int(floatval3))
print (int(strval1))
#print (int(strval2))		# Note you will get an error here because it's not a valid integer
